...
$result = mysqli_query ($connection,"SELECT*FROM tb_lokasi");
?>
  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        <!-- sidebar menu start-->
         <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered"><?php echo $_SESSION['nama']; ?>
          </h5>
          <li class="mt">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="container">
        <h3><i class="fa fa-angle-right"> Inventaris Ruang</i></h3>
        <div class="row mb">
          <!-- page start-->
          <div class="content-panel">
            <td><a href="form_ruang.php" class="btn btn-info">[+] Tambah Data</a> </td><br><br>
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone">Deskripsi Ruang</th>
                    <th class="">Aksi</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit_lokasi.php?id_ruang=<?php echo $row['id_ruang']; ?>" class="btn btn-custon-rounded-three btn-primary" type="button"><i class="glyphicon glyphicon-pencil"></i> </a>
                      <br /><br /><a href="hapus_lokasi.php?id_ruang=<?php echo $row['id_ruang']; ?>" class="btn btn-custon-rounded-three btn-danger" type="button"><i class="glyphicon glyphicon-trash"></i> </a>
                    </td>
                  </tr>
                  <?php
                endwhile;
    ...
    <footer class="site-footer">
      ...
      <p>
        ...
        <a href="lokasi.php#" class="go-top">
