...
$result = mysqli_query ($connection,"SELECT*FROM tb_perbaikan");
?>
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="container">
        <h3><i class="fa fa-angle-right"></i> Data Perbaikan </h3>
        <div class="row mb">
          <!-- page start-->
          <div class="content-panel">
            <td><a href="form_perbaikan.php" class="btn btn-info">[+] Tambah Data</a> </td><br><br>
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    <th class="hidden-phone">No. Perbaikan</th>
                    <th class="hidden-phone">Kode Barcode</th>
                    <th class="hidden-phone">Nama Barang</th>
                    <th class="hidden-phone">Lokasi</th>
                    <th class="hidden-phone">Uraian Masalah</th>
                    <th class="hidden-phone">Solusi</th>
                    <th class="hidden-phone">Tanggal Catat</th>
                    <th class="hidden-phone">Lama Perbaikan</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['lama_perbaikan']; ?></td>
                    <td><?php echo $row['biaya']; ?></td>
                    <td><?php echo $row['pengentri']; ?></td>
                    <td>
                      <a href="edit_perbaikan.php?id_perbaikan=<?php echo $row['id_perbaikan']; ?>" class="btn btn-custon-rounded-three btn-primary" type="button"><i class="glyphicon glyphicon-pencil"></i> </a>
                      <a href="perbaikan_selesai.php?id_perbaikan=<?php echo $row['id_perbaikan']; ?>" class="btn btn-custon-rounded-three btn-success" type="button"><i class="glyphicon glyphicon-ok"></i> </a>
                    </td>
                  </tr>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="tbl_perbaikan.php#" class="go-top">
