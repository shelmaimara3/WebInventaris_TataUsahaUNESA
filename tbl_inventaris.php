  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="container">
        <h3><i class="fa fa-angle-right"> Inventaris</i></h3>
        <div class="row mb">

          <!-- page start-->
          <div class="content-panel">
            <td><a href="form_inventaris.php" class="btn btn-info">[+] Tambah Data</a> </td><br><br>
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone">Pengguna</th>
                    <th class="hidden-phone">Processor</th>
                    <th class="hidden-phone">RAM</th>
                    <th class="hidden-phone">Hardisk</th>
                    <th class="hidden-phone">Monitor(inc)</th>
                    <th class="hidden-phone">Sistem Operasi</th>
                    <th class="hidden-phone">Anti Virus</th>
                    <th class="hidden-phone">Nama Ruang</th>
                    <th class="hidden-phone">Kondisi</th>
                    <th class="hidden-phone">Pengentri</th>
                    <th class="">Aksi</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row["hardisk"]; ?></td>
                    <td><?php echo $row["monitor_inc"]; ?></td>
                    <td><?php echo $row["sistem_operasi"]; ?></td>
                    <td><?php echo $row["anti_virus"]; ?></td>
                    <td><?php echo $row["nama_ruang"]; ?></td>
                    <td><?php echo $row["kondisi"]; ?></td>
                    <td><?php echo $row["pengentri"]; ?></td>
                    <td>
                        <a href="edit.php?no_inventaris=<?php echo $row['no_inventaris']; ?>" class="btn btn-custon-rounded-three btn-primary" type="button"><i class="glyphicon glyphicon-pencil"></i> </a>
                        <br /><br /><a href="hapus.php?no_inventaris=<?php echo $row['no_inventaris']; ?>" class="btn btn-custon-rounded-three btn-danger" type="button"><i class="glyphicon glyphicon-trash"></i> </a>
                        <br /><br /><a href="proses_keranjang.php?no_inventaris=<?php echo $row['no_inventaris']; ?>" class="btn btn-custon-rounded-three btn-success" type="button"><i class="glyphicon glyphicon-ok"></i> </a>
                    </td>
                  </tr>
   ...
   <footer class="site-footer">
      <div class="text-center">
        ...
        <div class="credits">
        <a href="tbl_inventaris.php#" class="go-top">
