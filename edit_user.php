  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mb">
          <form class="cmxform form-horizontal style-form" method="POST" action="prosesedit_user.php">
            <div class="form-group ">
              <label for="id" class="control-label col-lg-2">ID</label>
              <div class="col-sm-6">
                <input class=" form-control" id="id" name="id" type="int" value="<?php echo $row['id']; ?>" />
             </div>
           </div>
            <div class="form-group ">
              <label for="nama" class="control-label col-lg-2">Nama</label>
              <div class="col-sm-6">
                <input class=" form-control" id="nama" name="nama" type="text" value="<?php echo $row['nama'];  ?>" />
              </div>
            </div>
            <div class="form-group ">
            ...
            <div class="form-group ">
              ...
              <div class="col-sm-6">
                <input class="form-control " id="password" name="password" type="text" value="<?php echo $row['password'];  ?>" />
              </div>
            </div>
            <div class="form-group ">
            ...
            <div class="modal-footer">
              <div class="col-lg-offset-2 col-lg-10">
                ...
                <a href="list_user.php" class="btn btn-theme04">Cancel</a>
              </div>
            </div>
                </thead>
                </tbody>
