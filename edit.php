...
$no = $_GET['no_inventaris'];
$query = "SELECT * FROM tb_data WHERE no_inventaris= '$no'";
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="container">
        <h3><i class="fa fa-angle-right"></i> Edit Inventaris</h3>
        <div class="row mb">

          <form class="cmxform form-horizontal style-form" method="POST" action="proses_edit.php">
            <div class="form-group ">
              <label for="no_inventaris" class="control-label col-lg-2">No. Inventaris</label>
              <div class="col-sm-6">
                <input class=" form-control" id="no_inventaris" name="no_inventaris" type="text" value="<?php echo $row['no_inventaris'];  ?>" />
              </div>
            </div>
           <div class="form-group ">
            ...
            <div class="form-group ">
              ...
              <div class="col-sm-6">
                <input class="form-control " id="merk" name="merk" type="text" value="<?php echo $row['merk'];  ?>" />
              </div>
            </div>
            <div class="form-group ">
              <label for="pengguna" class="control-label col-lg-2">Pengguna</label>
              <div class="col-sm-6">
                <input class="form-control " id="pengguna" name="pengguna" type="text"  value="<?php echo $row['pengguna'];  ?>" />
              </div>
            </div>
            <div class="form-group ">
              <label for="processor" class="control-label col-lg-2" >Processor</label>
              <div class="col-sm-6">
                <input class="form-control " id="processor" name="processor" type="text" value="<?php echo $row['processor'];  ?>" />
              </div>
            </div>
            <div class="form-group ">
              <label for="ram" class="control-label col-lg-2" >RAM</label>
              <div class="col-sm-6">
                <input class="form-control " id="ram" name="ram" type="text" value="<?php echo $row['ram'];  ?>" />
              </div>
            </div>
            <div class="form-group ">
              <label for="hardisk" class="control-label col-lg-2" >Hardisk</label>
              <div class="col-sm-6">
                <input class="form-control " id="hardisk" name="hardisk" type="text" value="<?php echo $row['hardisk'];  ?>" />
              </div>
            </div>
            <div class="form-group ">
              <label for="monitor_inc" class="control-label col-lg-2" >Monitor(inc)</label>
              <div class="col-sm-6">
                <input class="form-control " id="monitor_inc" name="monitor_inc" type="text" value="<?php echo $row['monitor_inc'];  ?>" />
              </div>
            </div>
            <div class="form-group ">
              <label for="sistem_operasi" class="control-label col-lg-2" >Sistem Operasi</label>
              <div class="col-sm-6">
                <input class="form-control " id="sistem_operasi" name="sistem_operasi" type="text" value="<?php echo $row['sistem_operasi'];  ?>" />
              </div>
            </div>
            <div class="form-group ">
              <label for="anti_virus" class="control-label col-lg-2" >Anti Virus</label>
              <div class="col-sm-6">
                <input class="form-control " id="anti_virus" name="anti_virus" type="text" value=" <?php echo $row['anti_virus'];  ?>" />
              </div>
            </div>
              <div class="form-group ">
