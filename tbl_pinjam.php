...
$result = mysqli_query ($connection,"SELECT*FROM tb_pinjam");
?>
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="container">
        <h3><i class="fa fa-angle-right"> Peminjaman</i></h3>
        <div class="row mb">
          <!-- page start-->
          <div class="content-panel">
            <td><a href="form_pinjam.php" class="btn btn-info">[+] Tambah Data</a> </td><br><br>
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    <th class="hidden-phone">No. Surat</th>
                    <th class="hidden-phone">Kode Barcode</th>
                    <th class="hidden-phone">Nama Barang</th>
                    <th class="hidden-phone">Nama Peminjam</th>
                    <th class="hidden-phone">Asal</th>
                    <th class="hidden-phone">No Telp</th>
                    <th class="hidden-phone">Tanggal Pinjam</th>
                    <th class="hidden-phone">Tanggal Kembali</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['asal_peminjam']; ?></td>
                    <td><?php echo $row['no_telp']; ?></td>
                    <td><?php echo $row['tgl_pinjam']; ?></td>
                    <td><?php echo $row['tgl_kembali']; ?></td>
                    <td><?php echo $row['pengentri']; ?></td>
                    <td>
                      <a href="edit_pinjam.php?id=<?php echo $row['id']; ?>" class="btn btn-custon-rounded-three btn-primary" type="button"><i class="glyphicon glyphicon-pencil"></i> </a>
                      <a href="pinjam_selesai.php?id=<?php echo $row['id']; ?>" class="btn btn-custon-rounded-three btn-success" type="button"><i class="glyphicon glyphicon-ok"></i> </a>
                    </td>
                  </tr>
                  <?php
                endwhile;
    ...
    <footer class="site-footer">
      ...
      <p>
        ...
        <a href="tbl_pinjam.php#" class="go-top">
