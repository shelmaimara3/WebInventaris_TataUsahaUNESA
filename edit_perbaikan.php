...
$query = "SELECT * FROM tb_perbaikan WHERE id_perbaikan= '$id_perbaikan'";
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="container">
        <h3><i class="fa fa-angle-right"></i> Edit Perbaikan</h3>
        <div class="row mb">
          <form class="cmxform form-horizontal style-form" method="POST" action="proses_edit_perbaikan.php">
            <div class="form-group ">
              <label for="id_perbaikan" class="control-label col-lg-2">No. Perbaikan</label>
              <div class="col-sm-6">
                <input class=" form-control" id="id_perbaikan" name="id_perbaikan" type="text" value="<?php echo $row['id_perbaikan']; ?>" />
             </div>
           </div>
           <div class="form-group ">
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-6">
              <input class=" form-control" id="lokasi" name="lokasi" type="text" value="<?php echo $row['lokasi']; ?>" />
           </div>
         </div>
          <div class="form-group ">
            <label for="masalah" class="control-label col-lg-2" >Uraian Masalah</label>
            <div class="col-sm-6">
              <textarea class="form-control " id="masalah" type="text" name="masalah"><?php echo $row['masalah'];  ?></textarea>
            </div>
          </div>
            <div class="form-group ">
              <label for="solusi" class="control-label col-lg-2" >Solusi</label>
              <div class="col-sm-6">
                <textarea class="form-control " id="solusi" name="solusi" type="text"><?php echo $row['solusi'];  ?></textarea>
              </div>
            </div>
            <div class="form-group ">
              <label for="tgl_catat" class="control-label col-lg-2" >Tanggal Catat</label>
              <div class="col-sm-6">
                <input class="form-control " id="tgl_catat" name="tgl_catat" type="date" value="<?php echo $row['tgl_catat']; $tgl_catat = date('l,d-m-Y');  ?>" />
              </div>
            </div>
            <div class="form-group ">
              <label for="lama_perbaikan" class="control-label col-lg-2" >Lama Perbaikan</label>
              <div class="col-sm-6">
                <input class="form-control " id="lama_perbaikan" name="lama_perbaikan" type="text" value="<?php echo $row['lama_perbaikan'];  ?>" />
              </div>
            </div>
            <div class="form-group ">
              <label for="biaya" class="control-label col-lg-2" >Biaya</label>
              <div class="col-sm-6">
                <input class="form-control " id="biaya" name="biaya" type="text" value="<?php echo $row['biaya'];  ?>" />
              </div>
            </div>
            <div class="form-group ">
