              ...
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="">
                  <div class="form-group ">
                    ...
                    <div class="col-sm-6">
                      <input class=" form-control" id="id" name="id" type="int" />
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-sm-6">
                      <input class="form-control " id="username" name="username" type="text" placeholder="name@gmail.com"/>
                    </div>
                  </div>
                  <div class="form-group ">
...
if(isset($_POST['simpan'])){
     ...
     // buat query
    $mysqli = "INSERT INTO tb_user SET id='$id', nama='$nama', username='$username', password='$password',
    level='$level'";
        ...
        // kalau gagal alihkan ke halaman indek.php dengan status=gagal
				?>
					<script language="javascript">
						...
						document.location="form_pengguna.php";
					</script>
				<?php
        // echo "Input Gagal";
        //   header('location: form_pengguna.php');
