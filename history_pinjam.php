...
$result = mysqli_query ($connection,"SELECT * FROM history_pinjam");
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="container">
        <h3><i class="fa fa-angle-right"></i> Riwayat Peminjaman </h3>
        <div class="row mb">
          <!-- page start-->
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone">Asal Peminjam</th>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="history.php#" class="go-top">
